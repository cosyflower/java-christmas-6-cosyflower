...
public enum EventBadge {
    NOTHINIG("없음", (price) ->
            price.isBetweenPrice(Constants.INIT_VALUE, Constants.BADGE_FIRST_CRITERA)),
    STAR("별", (price) ->
            price.isBetweenPrice(Constants.BADGE_FIRST_CRITERA, Constants.BADGE_MIDDEL_CRITERA)),
    TREE("트리", (price) ->
            price.isBetweenPrice(Constants.BADGE_MIDDEL_CRITERA, Constants.BADGE_LAST_CRITERA)),
    SANTA("산타", (price) ->
            price.isBetweenPrice(Constants.BADGE_LAST_CRITERA, Integer.MAX_VALUE))
    ;
